          ...
          <div className="order-1 md:order-2">
              ...
              <div className="space-y-6">
                <div className="flex">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">support@pasteldress.com</p>
                ...
                <div className="flex">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">123 Fashion Avenue, Suite 100</p>
            ...
            <div className="bg-gray-100 rounded-lg p-6">
              ...
              <div className="flex space-x-4">
                ...
                >
                  <svg className="h-6 w-6 text-gray-500" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
